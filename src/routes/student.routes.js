...
router.route("/updateStudentProfilePicture").put(verifyStudentJWT, upload.single("profile"), updateProfilePicture);
router.route("/updateStudentProfileDetails").put(verifyStudentJWT, updateProfileDetails);
...
router
  .route("/getUnSubmittedAssignment")
  .get(verifyStudentJWT, getUnSubmittedAssignment);
router
  .route("/getSubmittedAssignment")
  .get(verifyStudentJWT, getSubmittedAssignment);

router
  .route("/editSubmittedAssignment/:assignmentId")
  .put(verifyStudentJWT, editSubmittedAssignment);
router
  .route("/deleteSubmittedAssignment/:assignmentId")
  .delete(verifyStudentJWT, deleteSubmittedAssignment);
